...
public static class TargetExtensions
{
    extension<T>(T target) where T : ITarget
    {
        ...
        /// <returns></returns>
        public T After(params IEnumerable<ITarget> targets)
        {
            foreach (var linkedTarget in targets) target.After.Add(linkedTarget);
        ...
        /// <param name="targets"></param>
        /// <returns></returns>
        public T Before(params IEnumerable<ITarget> targets)
        {
            foreach (var linkedTarget in targets)
            {
                linkedTarget.After.Add(target);
            }
        ...
        /// <param name="targets"></param>
        /// <returns></returns>
        private T TriggeredBy(params IEnumerable<ITarget> targets)
        {
            foreach (var linkedTarget in targets)
            {
                linkedTarget.Triggers.Add(target);
            }
        ...
        /// <param name="targets"></param>
        /// <returns></returns>
        public T TriggeredAfter(params IEnumerable<ITarget> targets)
        {
        ...
        /// <param name="targets"></param>
        /// <returns></returns>
        public T DependentFor(params IEnumerable<ITarget> targets)
        {
            target.TriggeredBy(targets);
        ...
        /// <param name="targets"></param>
        /// <returns></returns>
        private T Triggers(params IEnumerable<ITarget> targets)
        {
            foreach (var linkedTarget in targets)
            {
        ...
        /// <param name="targets"></param>
        /// <returns></returns>
        public T TriggersAfter(params IEnumerable<ITarget> targets)
        {
        ...
        /// <param name="targets"></param>
        /// <returns></returns>
        public T DependsOn(params IEnumerable<ITarget> targets)
        {
            target.Triggers(targets);
            return target.After(targets);
        }
